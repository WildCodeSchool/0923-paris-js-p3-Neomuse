...
CREATE TABLE IF NOT EXISTS `neo_muse`.`artwork_technique` (
  ...
  CONSTRAINT `fk_artwork_technique_sub_technique1`
    ...
    REFERENCES `neo_muse`.`sub_technique` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `neo_muse`.`set_favorite` (
  ...
  CONSTRAINT `fk_users_has_artworks_users1`
    ...
    REFERENCES `neo_muse`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_has_artworks_artworks1`
    FOREIGN KEY (`artworks_id`)
    REFERENCES `neo_muse`.`artworks` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);


-- -----------------------------------------------------
-- Table `neo_muse`.`exhibit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `neo_muse`.`exhibit` (
  ...
  CONSTRAINT `fk_events_has_artworks_events1`
    FOREIGN KEY (`events_id`)
    REFERENCES `neo_muse`.`events` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_events_has_artworks_artworks1`
    FOREIGN KEY (`artworks_id`)
    REFERENCES `neo_muse`.`artworks` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
